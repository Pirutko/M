...
-- Renumbered from 050 to 054 to avoid a duplicate Netlify migration number.
...
SET species='Сетчатый жираф', scientific_name='Giraffa reticulata', subspecies=ARRAY[]::text[]
WHERE id='zoo-giraffe';

UPDATE animal_catalog
SET species='Западная горилла', scientific_name='Gorilla gorilla', subspecies=ARRAY['западная равнинная горилла','кросс-риверская горилла']::text[]
